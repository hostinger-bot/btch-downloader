...
The contributor and AI-agent guide lives in **[AGENTS.md](AGENTS.md)** — start there. It covers repo layout, setup, prerequisites, all 18 platform functions, coding rules, build commands, and what not to touch.
...
For the live playground and full API docs, see https://btch.foo.ng/