...
> Last verified: **September 13, 2026** · Latest stable version: **6.4.0**
...
**btch-downloader** is a lightweight TypeScript/JavaScript client SDK for downloading videos, images, and audio from social media platforms. It does **not** scrape platforms directly — all platform-specific logic is handled by the backend service at `backend1.tioo.eu.org`.

| Field          | Value                                                    |
|----------------|----------------------------------------------------------|
| npm package    | `btch-downloader`                                        |
| Latest version | `6.4.0` (published ~September 13, 2026)                        |
...
- **No heavy dependencies:** Keep the SDK lightweight.
...
<!-- Pinned to 6.4.0 -->
<script src="https://cdn.jsdelivr.net/npm/btch-downloader@6.4.0/dist/browser/index.min.js"></script>
...
- This client SDK is **only for publicly accessible content**.
- It is **not affiliated** with any platform.
- Ensure you have **permission or copyright clearance** before downloading any content.

The following platforms are no longer actively maintained — do not extend them:
